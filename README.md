...
The components listed below work in Tcl 8.5, Tcl 8.6, Tcl 8.7, and Jim Tcl 0.76
or later unless indicated otherwise.  Each component is versioned separately.
Component version numbers follow [semantic
...
5\. Only the compatible components are tested in Tcl 8.
